...
<div>
    ...
    <form:form action="${pageContext.request.contextPath}/account/update" method="post" modelAttribute="accountUpdateForm">
        ...
        <table>
            ...
            <tr>
                <td><form:label path="creditLimit" cssErrorClass="error-label">credit limit of your card</form:label></td>
                <td><form:input path="creditLimit" cssErrorClass="error-input" />
                    <form:errors path="creditLimit" cssClass="error-messages" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
